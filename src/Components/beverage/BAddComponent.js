...
class BAddComponent extends Component {
  constructor(props){
     super(props);
     this.state = {
        beverage_name:"",
  ...
  onSubmit=(e)=>{
    ...
    axios.post('http://localhost:3001/beverage/addnewbe',data).then(
        res=>{
            Swal.fire({
                icon: 'success',
         ...
         <div className="container">
               ...
               <div className="row">
                  <div className="grap-content">
                    <Link className="btn btn-primary" to="/bindex">Return Index</Link>
                     <form action="#" method="POST" onSubmit={this.onSubmit}>
                        <legend>Form Add Beverage</legend>
                     
                        <div className="form-group">
                            <label htmlFor="">Beverage Name</label>
                            <input type="text" className="form-control" name="beverage_name" onChange={this.onChangeBeverageName} placeholder="Input field" />
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            <input type="number" className="form-control" name="beverage_price" onChange={this.onChangeBeveragePrice} placeholder="Input field" />
                        </div>

                        <div className="form-group">
                            <label htmlFor="">Beverage Sale Price</label>
                            <input type="number" className="form-control" name="beverage_sale_price" onChange={this.onChangeBeverageSalePrice} placeholder="Input field" />
                        </div>
                        
                        <div className="form-group">
                            <label htmlFor="">Beverage Quantity</label>
                            <input type="number" className="form-control" name="beverage_quantity" onChange={this.onChangeBeverageQuantity} placeholder="Input field" />
                        </div>
